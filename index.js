...
// const totalUnfundedReduce = GAMES_JSON.reduce((acc, game) => {
...
const strDisplay = `A total of $${totalRaised.toLocaleString()} has been raised for ${GAMES_JSON.length} games. 
                    Currently, ${totalUnfunded > 1 ? `${totalUnfunded} games remain` : '1 game remains'} unfunded. 
